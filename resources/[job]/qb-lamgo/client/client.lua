...
local sellX4 = 1205.84  -- 1205.84 -1271.42 35.23
local sellY4 = -1271.42
local sellZ4 = 35.23
local model1 = Config.ModelCar --model
local delX = 1187.84  --del auto 1187.84 -1286.76 34.95
local delY = -1286.76
local delZ = 34.95
...
Citizen.CreateThread(function()
   ...
   while QBCore.Functions.GetPlayerData().job == nil do
    ...
    addBlip2(Config.Sell, 207, 1, Strings['sell_wood'])
    Citizen.CreateThread(function()
        while true do
            local sleep = 250
            if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), Config.Sell, true) <= 3.0 then
                ...
                if IsControlJustReleased(0, 38) then
                    TriggerServerEvent('qb-lamgo:sell')
...
addBlip2 = function(coords, sprite, colour, text)
    local blip = AddBlipForCoord(coords)
    SetBlipSprite(blip, sprite)
    SetBlipColour(blip, colour)
    SetBlipAsShortRange(blip, true)
