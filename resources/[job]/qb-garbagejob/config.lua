...
Config.Locations = {
    ["main"] = {
        label = "~g~Công Ty Xử Lý Rác",
        coords = vector4(-321.09, -1529.58, 27.55, 268.55),
    },
    ["vehicle"] = {
        label = "Lưu trữ xe tải rác", --vector4(-331.17, -1526.02, 27.54, 270.64),
        coords = vector4(-331.17, -1526.02, 27.54, 270.64),
    },
    ["paycheck"] = {
        label = "Tiền lương",
        coords = vector4(-328.36, -1534.03, 27.71, 176.9),
    },
    ["trashcan"] ={
        [1] = {
            name = "forumdrive",
