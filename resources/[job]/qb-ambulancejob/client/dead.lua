	...
	while true do
		...
		EnableControlAction(0, 249, true)
                ...
                if LaststandTime > Laststand.MinimumRevive then
                    DrawTxt(0.94, 1.44, 1.0, 1.0, 0.6, "BẠN ĐANG BẤT TỈNH : ~r~" .. math.ceil(LaststandTime) .. "~w~ GIÂY", 255, 255, 255, 255)
                else
                    DrawTxt(0.845, 1.44, 1.0, 1.0, 0.6, "BẠN ĐANG BẤT TỈNH : ~r~" .. math.ceil(LaststandTime) .. "~w~ GIÂY , HÃY GỌI CẤP CỨU", 255, 255, 255, 255)
                end
