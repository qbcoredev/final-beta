...
Config.Locations = {
    ...
    ["helicopter"] = {
        [1] = vector4(350.8, -588.0, 74.17, 94.47),
    },    
    ["armory"] = {
...
Config.Vehicles = {
    ["amr13fpiu"] = "Xe Cấp Cứu 1",
    ["amr16fpiu"] = "Xe Cấp Cứu 2",
    ["amr18tahoe"] = "Xe Cấp Cứu 3",
    ["amrf150cr_hi"] = "Xe Cấp Cứu 4",
    ["amrf250cr"] = "Xe Cấp Cứu 5",
}
...
Config.BleedingStates = {
    [1] = {label = 'Bạn đang bị thương nhẹ..', damage = 10, chance = 50},
    [2] = {label = 'Bạn bị chảy máu..', damage = 15, chance = 65},
    [3] = {label = 'Bạn đang bị chảy máu quá nhiều..', damage = 20, chance = 65},
    [4] = {label = 'Sắp Hóa Kiếp Rồi bạn..', damage = 25, chance = 75},
}
