...
Config.CostMultiplier = 15.0

-- Configure the strings as you wish here.
Config.Strings = {
	ExitVehicle = "Ra Khỏi Xe Để Thực Hiện",
	EToRefuel = "BẤM ~g~E ~w~ĐỂ ĐỔ XĂNG",
	JerryCanEmpty = "Can Xăng Trống",
	FullTank = "Xe Đã Đầy Xăng",
	PurchaseJerryCan = "BẤM ~g~E ~w~Để Mua Can Xăng Với Gía ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Bấm ~g~E ~w~để dừng đổ xăng",
	CancelFuelingJerryCan = "Bấm ~g~E ~w~để dừng đổ xăng",
