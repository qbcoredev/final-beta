...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Chọn Vị Trí?"><p><span id="null">Chọn Vị Trí?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Vị Trí Lần Trước"><p><span id="current-location">Vị Trí Lần Trước</span></p></div>');
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Chọn Nhà"><p><span id="null">Chọn Nhà</span></p></div>')
