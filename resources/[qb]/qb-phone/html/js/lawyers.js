SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 71, 0);">Độ Xe (' + doxe.length + ')</h1>');

        if (doxe.length > 0) {
            $.each(doxe, function(i, lawyer2) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There are no doxe available.</div></div>'
            $(".lawyers-list").append(element);
        }
