...
AddEventHandler('qb-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Tiếp Nhiên Liệu Thuyền ..", 20000, false, true, {
            ...
            QBCore.Functions.Notify('Thuyền đã được tiếp nhiên liệu', 'success')
            ...
            QBCore.Functions.Notify('Tiếp nhiên liệu đã bị hủy bỏ!', 'error')
        end)
    else
        QBCore.Functions.Notify('Bạn không ở trong một chiếc thuyền', 'error')
    end
end)
