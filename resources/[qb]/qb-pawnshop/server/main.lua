local ItemList = {
    ...
    ["diamond_ring"] = math.random(120, 220),
    ["rolex"] = math.random(100, 200),
    ["10kgoldchain"] = math.random(100, 200),
    ["tablet"] = math.random(90, 190),
    ["iphone"] = math.random(80, 180),
    ["samsungphone"] = math.random(90, 190),
    ["laptop"] = math.random(100, 200),
