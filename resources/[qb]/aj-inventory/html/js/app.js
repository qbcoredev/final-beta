...
/*             "weapon_pistol_mk2", 
    ...
    Inventory.Open = function(data) {
        ...
        $(".pro").css("width",per+"%");
        $("#player-inv-weight").html("Cân Nặng: " + (totalWeight / 1000).toFixed(2) + " / " + (data.maxweight / 1000).toFixed(2) + " lbs");
        ...
        if (data.other != null) 
        {
            ...
            if (name != null && (name.split("-")[0] == "itemshop" || name == "crafting")) {
                ...
                $("#other-inv-label").html(data.other.label)
                $("#other-inv-weight").html("Cân Nặng: " + (totalWeightOther / 1000).toFixed(2) + " / " + (data.other.maxweight / 1000).toFixed(2) + " lbs")
            ...
            $("#other-inv-weight").html("Cân Nặng: " + (totalWeightOther / 1000).toFixed(2) + " / " + (Inventory.dropmaxweight / 1000).toFixed(2) + " lbs")
