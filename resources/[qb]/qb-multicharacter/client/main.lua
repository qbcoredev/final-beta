...
Config = {
    PedCoords = vector4(389.53, -356.03, 48.02, 273.87),
    HiddenCoords = vector4(359.51, -326.2, 46.7, 257.41), 
    CamCoords = vector4(392.06, -355.75, 48.02, 95.28),
}
...
function skyCam(bool)
    ...
    if bool then
        ...
        cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 392.06, -355.75, 48.02, 0.0 ,0.0, 95.28, 60.00, false, 0)
