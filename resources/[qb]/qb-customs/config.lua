maxVehiclePerformanceUpgrades = 3 -- Set to 0 to have all the upgrades
...
bennyGarages = {
    [1] = {coords = vector4(-211.55, -1324.55, 30.90, 319.73135375977), useJob = true, job = {"doxe"}},
}
...
vehicleResprayCategories = {
    {category = "Màu Chính", id = 0},
    {category = "Màu Phụ", id = 1},
    {category = "Màu ngọc trai", id = 2},
    {category = "Màu Bánh Xe", id = 3},
    {category = "Màu trang tổng quan", id = 4},
    {category = "Màu nội thất", id = 5}
}
...
vehicleCustomisation = {
    ...
    {category = "Cản trước", id = 1},
    {category = "Cản sau", id = 2},
    {category = "Bên Hông", id = 3},
    {category = "Khí thải", id = 4},
    ...
    {category = "Nóc Xe",id = 10},
    {category = "Độ Động Cơ", id = 11},
    {category = "Độ Phanh", id = 12},
    {category = "Độ Bộ Truyền Tải", id = 13},
    {category = "Độ Hệ Thống Treo", id = 15},
    {category = "Độ Giáp", id = 16},
    {category = "Độ Turbo", id = 18},
    {category = "Biển Số",id = 25},
    {category = "Trim A", id = 27},
    {category = "Độ trang trí", id = 28},
    {category = "Điều Khiển", id = 29},
    {category = "Đồng Hồ Tốc Độ", id = 30},
    {category = "Loa Xe", id = 31},
    ...
    {category = "Phuộc Nhún", id = 41},
    {category = "Arch Cover", id = 42},
    {category = "Ăng Ten", id = 43},
    {category = "Trim B", id = 44},
    {category = "Bình Nhiên Liệu", id = 45},
    {category = "Cửa Sổ", id = 46},
    {category = "Tem Xe", id = 48},
    {category = "Kèn Xe", id = 14, 
