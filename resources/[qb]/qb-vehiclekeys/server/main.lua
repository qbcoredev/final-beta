...
QBCore.Commands.Add("dongco", "Bật Tắt Động Cơ", {}, false, function(source, args)
	TriggerClientEvent('vehiclekeys:client:ToggleEngine', source)
end)

QBCore.Commands.Add("duachiakhoa", "Đưa Chìa Khóa", {{name = "id", help = "Player id"}}, true, function(source, args)
	local src = source
