...
RegisterServerEvent('qb-houserobbery:server:callCops')
AddEventHandler('qb-houserobbery:server:callCops', function(type, safe, streetLabel, coords)
    local data = {displayCode = '911', description = 'Cướp Nhà Dân', isImportant = 0, recipientList = {'police'}, length = '10000', infoM = 'fa-info-circle', info = 'Đang Có Một Căn Hộ Bị Đột Nhập'}
