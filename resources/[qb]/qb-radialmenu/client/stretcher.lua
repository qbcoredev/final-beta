...
RegisterNetEvent('qb-radialmenu:client:TakeBrancard')
AddEventHandler('qb-radialmenu:client:TakeBrancard', function()
    local PlayerPed = PlayerPedId()
    local PlayerPos = GetEntityCoords(PlayerPed)
...
RegisterNetEvent('qb-radialmenu:client:RemoveBrancard')
AddEventHandler('qb-radialmenu:client:RemoveBrancard', function()
    local PlayerPed = PlayerPedId()
