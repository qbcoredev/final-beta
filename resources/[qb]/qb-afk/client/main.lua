                ...
                if prevPos ~= nil then
                    if currentPos == prevPos then
                        if time ~= nil then
                            if time > 0 then
                                if time == (900) then
                                    QBCore.Functions.Notify('Bạn đang AFK và sẽ bị kích trong ' .. math.ceil(time / 60) .. ' phút!', 'error', 10000)
                                ...
                                elseif time == (60) then
                                    QBCore.Functions.Notify('Bạn đang AFK và sẽ bị kích trong ' .. math.ceil(time / 60) .. ' phút!', 'error', 10000) 
                                elseif time == (30) then
                                    QBCore.Functions.Notify('Bạn đang AFK và sẽ bị kích trong ' .. time .. ' giây!', 'error', 10000)  
                                elseif time == (20) then
                                    QBCore.Functions.Notify('Bạn đang AFK và sẽ bị kích trong ' .. time .. ' giây!', 'error', 10000)    
                                elseif time == (10) then
                                    QBCore.Functions.Notify('Bạn đang AFK và sẽ bị kích trong ' .. time .. ' giây!', 'error', 10000)                                                                                                            
